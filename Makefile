...
SandBox-Linux-Debug:
	 $(PROJECTBUILD) SandBox Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBox-Linux-DebugGame:
	 $(PROJECTBUILD) SandBox Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBox-Linux-Shipping:
	 $(PROJECTBUILD) SandBox Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBox-Linux-Test:
	 $(PROJECTBUILD) SandBox Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBox:
	 $(PROJECTBUILD) SandBox Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBoxEditor-Linux-Debug:
	 $(PROJECTBUILD) SandBoxEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBoxEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SandBoxEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBoxEditor-Linux-Shipping:
	 $(PROJECTBUILD) SandBoxEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBoxEditor-Linux-Test:
	 $(PROJECTBUILD) SandBoxEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SandBoxEditor:
	 $(PROJECTBUILD) SandBoxEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
